...
$this->data['text_manufacturer_categories'] = $this->language->get('text_manufacturer_categories');
...
$this->data['manufacturer_category'] = $this->url->link('catalog/manufacturer_category', 'token=' . $this->session->data['token'], 'SSL');
