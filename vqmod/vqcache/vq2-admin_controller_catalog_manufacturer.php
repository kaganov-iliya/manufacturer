...
$this->data['entry_category'] = $this->language->get('entry_category');
		...
		$this->data['no_image'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
			...
			$this->data['categories'] = $this->model_catalog_manufacturer_category->getCategories(0);

			if (isset($this->request->post['manufacturer_category'])) {
				$this->data['manufacturer_category'] = $this->request->post['manufacturer_category'];
			} elseif (isset($this->request->get['manufacturer_id'])) {
				$this->data['manufacturer_category'] = $this->model_catalog_manufacturer->getManufacturerCategories($this->request->get['manufacturer_id']);
			} else {
