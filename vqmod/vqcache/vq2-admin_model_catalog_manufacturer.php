		...
		foreach ($data['manufacturer_description'] as $language_id => $value) {
			...
			if (isset($data['manufacturer_category'])) {
				foreach ($data['manufacturer_category'] as $category_id) {
					$this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer_to_category SET manufacturer_id = '" . (int)$manufacturer_id . "', manufacturer_category_id = '" . (int)$category_id . "'");
				}
			}
	...
	public function getTotalManufacturersByImageId($image_id) {
		...
		return $query->row['total'];
			...
			public function getManufacturerCategories($manufacturer_id) {
				...
				foreach ($query->rows as $result) {
					$manufacturer_category_data[] = $result['manufacturer_category_id'];
				}
