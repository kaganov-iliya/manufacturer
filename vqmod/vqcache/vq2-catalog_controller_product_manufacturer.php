...
class ControllerProductManufacturer extends Controller {  
	public function index() { 
		...
		$this->data['button_continue'] = $this->language->get('button_continue');
			...
			if(isset($this->request->get['manufacturer_category_id'])){
			$this->data['linktopage'] =	$this->url->link('product/manufacturer', "manufacturer_category_id=".$this->request->get['manufacturer_category_id']);
			}else{
				$this->data['linktopage'] =	$this->url->link('product/manufacturer');
			}
		...
		$this->data['categories'] = array();
			...
			if(isset($this->request->get['manufacturer_category_id'])){
				$manufacturer_category_id = explode("_", $this->request->get['manufacturer_category_id']);
			}else{
				$manufacturer_category_id = 0;
			}

			$data = array(
				'manufacturer_category_id' => $manufacturer_category_id,
			);
