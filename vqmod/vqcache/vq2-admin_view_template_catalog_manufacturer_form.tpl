          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><div class="scrollbox">
                  ...
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div class="<?php echo $class; ?>">
                    <?php if (in_array($category['manufacturer_category_id'], $manufacturer_category)) { ?>
                    <input type="checkbox" name="manufacturer_category[]" value="<?php echo $category['manufacturer_category_id']; ?>" checked="checked" />
                    <?php echo $category['name']; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="manufacturer_category[]" value="<?php echo $category['manufacturer_category_id']; ?>" />
                    <?php echo $category['name']; ?>
                    <?php } ?>
                  </div>
                  <?php } ?>
